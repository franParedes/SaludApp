...
// Componente de formulario actualizado a RegisterForm
import RegisterForm from './components/RegisterForm'; 
// Asumimos que useCrearMedico y Medico se importan correctamente de hooks
import { useCrearMedico } from '../../hooks/useMedico'; 
import {type Medico} from '../../types/Medico'; 
import { useState } from 'react';

// Se mantiene el tipo FormData
interface FormData {
    primerNombre?: string;
